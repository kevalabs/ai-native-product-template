---
description: "Dump a raw idea into the backlog — ten-second capture, no interview"
argument-hint: "<the idea, in one line>"
---

Capture this idea in the backlog: $ARGUMENTS
...
4. Confirm in one line. Do not commit; backlog lines ride along with
